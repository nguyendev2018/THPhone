<?php 
    ...
    if(isset($_GET['madm'])){
        $madm=$_GET['madm'];
        $Showdm=new Showdm();
        $showProduct=$Showdm->ShowWithDm($madm);
    }
    if(isset($_GET['dequi'])){
        $dequi=$_GET['dequi'];
        $Showdm=new Showdm();
        $showProduct=$Showdm->ShowWithCategory($dequi);
    }
    if(isset($_GET['dungluong'])){
        $dungluong=$_GET['dungluong'];
        $Showdm=new Showdm();
        $showProduct=$Showdm->ShowWithDungluong($dungluong);
    }
    if(isset($_GET['mausac'])){
        $mausac=$_GET['mausac'];
        $Showdm=new Showdm();
        $showProduct=$Showdm->ShowWithMausac($mausac);
    }
                        ...
                        <div class="shop-top-bar mt-30">
                            <div class="shop-bar-inner">
                                ...
                                <div class="toolbar-amount">
                                    <span>Danh sách 1 đến 12 của <?php echo $count ?></span>
                                </div>
                            </div>
                            ...
                            <div class="product-select-box">
                                <div class="product-short">
                                    ...
                                    <select class="nice-select">
                                            ...
                                            <option value="date">Xếp hạng</option>
                                                    ...
                                                    <div class="product_desc">
                                                        ...
                                                        <div class="add-actions">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active"><a href="?act=shopping-cart">Thêm giỏ hàng</a></li>
                                                ...
                                                <div class="col-lg-3 col-md-5 ">
                                                    <div class="product-image">
                                                        <a href="?act=single-product">
                                                            <img src="<?php echo $data1['hinhanh'];?>" alt="Li's Product Image">
                                                        </a>
                                                        <span class="sticker">Mới</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="shop-add-action mb-xs-30">
                                                        <ul class="add-actions-link">
                                                            ...
                                                            <li class="wishlist"><a href="?act=wishlist"><i class="fa fa-heart-o"></i>Thêm vào yêu thích</a></li>
                                ...
                                <div class="paginatoin-area">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 pt-xs-15">
                                            <p>Danh sách 1-12 of 13 sản phẩm</p>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <ul class="pagination-box pt-xs-20 pb-xs-15">
                                                <li><a href="#" class="Previous"><i class="fa fa-chevron-left"></i> Lùi về</a>
                                                </li>
