...
$mail->Username = "nguyennttps08770@fpt.edu.vn";

//Password to use for SMTP authentication
$mail->Password = "nguyenkhoavy@54321";
...
$mail->msgHTML('Chúng tôi đã nhận được mail sẽ trả lời trong thời gian sớm nhất ');
...
if ($mail->send()) {
    echo "<alert>Chúng tôi đã nhận được mời bạn kiểm tra Email </alert>";
} 
